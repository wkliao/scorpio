...
static int PIOc_write_darray_adios(file_desc_t *file, int varid, 
		int ioid, io_desc_t *iodesc,
...
static void PIOc_write_decomp_adios(file_desc_t *file, int ioid)
{
	...
	if (iodesc->maplen>1) {
		av_shape[0]  = (size_t)iodesc->maplen;
		av_start[0]  = (size_t)0;
